...
$(function() {
  ...
  App.Views.SidebarItem = React.createClass({
    render: function(){
      ...
      return (
        <li className={liClass} onClick={this.props.changePill.bind(null,this.props.titleLC)}>
  ...
  App.Views.Sidebar = React.createClass({
    ...
    render: function(){
      ...
      return (
        <div>
          <p>
            <button type="button" ref="menu" onClick={this.props.toggleMenuVisibility} className="btn btn-info">Menu</button>
          </p>
